...
assert.doesNotMatch(context._flowDestinationHtml({id:1,target_folder:'/old'}), /flow-target-folder|flow-adopt-folder/);
assert.match(context._flowDestinationHtml({id:1,source_type:'file'}), /Created automatically/);
