...
def register(identity, *, controls=True):
    flows.register_worker(flows.WorkerRegister(worker_id=identity, display_name=identity, capabilities={
        'headed': True, 'browser_switch_v1': True, 'flow_recorder_v1': True, 'recorded_flows_v2': True, 'recorded_flows_v3': True, 'recorded_flows_v4': True, 'recorded_validation_engine_v1': True,
