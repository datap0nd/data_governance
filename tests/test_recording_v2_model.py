...
def test_validation_requires_worker_engine_check_capability(flow_db):
    ...
    with database.get_db() as db:
        scan=flow_recordings.queue_operation(db,saved['id'],'validate','test',revision_id=revision)
    caps={'headed':True,'recorded_flows_v2':True,'recorded_flows_v3':True,'recorded_flows_v4':True,'recorded_flows_v5':True,'browser_switch_v1':True,'flow_recorder_v1':True,'flow_recorder_controls_v1':True}
