...
function usersPageHtml() {
    ...
    return `<div class="users-page" id="users-page">
        ...
        <p class="users-muted">SQL usernames are optional. Assigned Flows apply this role as their target table owner on the next successful SQL load when that Flow enables SQL table ownership, including existing tables. Saving a profile does not change the database immediately. Already queued runs keep their saved owner.</p>`}
    </div>`;
}
