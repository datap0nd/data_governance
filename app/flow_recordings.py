...
def queue_operation(db, flow_id, operation, actor, *, revision_id=None, pending_settings=None):
    ...
    job = {'schema_version': 1, 'job_type': 'catalog_scan', 'recording_operation': operation,
           'recording_flow_id': flow_id, 'recording_version': 5, 'recorder_controls': 1, 'execution': {'browser_mode': 'headed', 'browser_channel': flow_browser.configured(db)}, 'browser_channel': flow_browser.configured(db),
