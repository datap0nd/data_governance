...
Data: {sources_fresh} healthy, {sources_stale} at risk, {sources_outdated} degraded, {sources_unknown} unknown out of {sources_total} sources.
...
Overall: {fresh_count} healthy, {stale_count} at risk, {no_conn_count} no connection, {unknown_count} unknown."""

SUGGESTIONS_TEMPLATE = """Given the current state, suggest 3-5 actionable improvements.
State: {sources_total} sources ({no_conn_count} with no connection, {stale_count} at risk, {outdated_count} degraded).
