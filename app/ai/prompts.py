...
Data: {sources_fresh} fresh, {sources_stale} stale, {sources_outdated} outdated, {sources_unknown} unknown out of {sources_total} sources.
...
Overall: {fresh_count} fresh, {stale_count} stale, {no_conn_count} no connection, {unknown_count} unknown."""

SUGGESTIONS_TEMPLATE = """Given the current state, suggest 3-5 actionable improvements.
State: {sources_total} sources ({no_conn_count} with no connection, {stale_count} stale, {outdated_count} outdated).
