...
- Evidence cutoff (UTC): 2026-09-25 11:53
- Tested code revision: `56f6f5b3f0be928f1650859b3c53568187716d66` for the
  application, tests and `setup.ps1`. `674fabeee8764a0e50a5919fdfbfcdeaafbe33f4`
  adds only preview styling; the preview walkthrough, frontend contracts,
  JavaScript syntax and PowerShell parse ran there. This report and its
  evidence files are the only later changes.
