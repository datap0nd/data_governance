...
- Change/PR: pending
- Evidence cutoff (UTC): 2026-09-09T13:34:07Z
- Tested code revision: uncommitted working tree based on `ff6f9e83f7bed1bd47e44e734ec344e0a8abe2fd`; final committed SHA pending.
...
| --- | --- | --- | --- |
| Full automated matrix | NOT RUN | Implementation still in progress at this evidence cutoff. | Run affected and full suites on the committed head. |
