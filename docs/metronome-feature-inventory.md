...
| Main | Flows / `#flows` | File, Outlook, Python-script and website acquisition; recorded and catalog-based flows; schedules, owners, transformations, SQL insertion, downstream materialized-view refresh and emailing the final file to configured recipients. Tabs: Flows, Catalog, Run history, Settings. |
